...
import ass10_1.employeebst.Employee;
import ass10_1.employeebst.NameComparator;
...
public class EmployeeBST {
	...
	private boolean find(Employee x, Node n){
		...
		return (comparator.compare(x, n.element) < 0) ?
				find(x,n.left) :
				find(x,n.right);
	...
	public static void main(String[] args){
		...
		Employee emp1 = new Employee("john", 1200, 2000, 9, 9);
		Employee emp2 = new Employee("Anamuel", 1200, 2000, 9, 9);
		
			bst.insert(emp1);
//			bst.insert(new Integer(2*i - 5));
		
		bst.printTree();
		System.out.println("Is "+emp1.getName()+" in the tree? "+bst.find(emp1));
		System.out.println("Is "+emp2.getName()+" in the tree? "+bst.find(emp2));
